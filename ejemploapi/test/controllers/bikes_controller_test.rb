...
class BikesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bike" do
    assert_difference('Bike.count') do
      post bikes_url, params: { bike: { color: @bike.color, id: @bike.id, owner: @bike.owner, type: @bike.type } }, as: :json
    end
  ...
  test "should update bike" do
    patch bike_url(@bike), params: { bike: { color: @bike.color, id: @bike.id, owner: @bike.owner, type: @bike.type } }, as: :json
    assert_response 200
  end
